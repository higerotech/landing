...
> DAST—, de los cuales ya solo falta **license**: son **6 de 7**. Dos listas de siete, distintas.
...
| 3 | Pruebas | 🟡 **Los cinco checkboxes cumplidos**, matriz OWASP y mutación incluidas. Cerrarlo es decisión del owner | [gate-3](.ai-dlc/gates/gate-3-testing.md) |
