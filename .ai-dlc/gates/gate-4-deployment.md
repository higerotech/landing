...
| 5 | ~~HSTS~~ | **Hecho** el 2026-07-31: `max-age=31536000; includeSubDomains; preload` (12 meses), emitido por Cloudflare y verificado en varios hostnames y rutas. El fleco del `preload` **se cerró el mismo día** al enrutar el apex, y la precarga **se solicitó**: chequeo oficial sin errores ni avisos, dominio en estado `pending` con `force-https` e `include_subdomains`. Falta que los navegadores la incorporen, que son semanas |
